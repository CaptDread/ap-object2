...
var FullNameValidator = /*#__PURE__*/function (_BaseValidator) {
  _inherits(FullNameValidator, _BaseValidator);
  ...
  _createClass(FullNameValidator, [{
    key: "validate",
    value: function validate(value) {
      var nameInp = document.querySelector("[name=\"name\"]");
